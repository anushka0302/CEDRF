      ...
      <div className="p-6">
        <h1 className="text-4xl font-serif italic text-white mb-8 text-center">
          <span className="inline-flex items-center justify-center gap-3">
            <SiLaunchpad className="text-red-400" />
            Job Opportunities
            <SiLaunchpad className="text-red-400" />
          </span>
        </h1>
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 max-w-6xl mx-auto">
          <input
            ...
            className="w-full md:w-1/3 px-4 py-3 italic  bg-white/10 border border-gray-700 rounded-sm text-white placeholder-gray-400 focus:border-red-400 focus:outline-none transition-colors"
            value={search}
          ...
          <div className="flex gap-3">
            {["All", "MNC", "Government", "Internship"].map((tag) => (
              <button
                key={tag}
                className={`px-2 py-1 rounded-sm border italic transition-colors bg-white/10 bg-opacity-20 backdrop-blur-sm border-red-500 border-opacity-30
        ${
          filter === tag
            ? "text-red-500 opacity-80"
            : "text-white border-gray-700 hover:border-red-400 hover:text-red-400"
        }`}
            ...
            paginatedJobs.map((job, idx) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-xs px-1 py-0.5 text-white italic rounded-sm border border-red-500 border-opacity-30 bg-white/10 bg-opacity-20 backdrop-blur-sm">
                    {job.Tag}
                  </span>
                </div>
                ...
                <a
                  ...
                  className="inline-block mt-auto px-5 py-2 text-red-500  rounded-lg hover:text-red-600 transition-colors font-semibold"
                >
                  Apply Now →
                </a>
              </div>
        ...
        ${page === 1 ? "opacity-40 cursor-not-allowed" : "hover:text-red-400"}
      `}
            >
              ...
              <button
                ...
                className={`px-2 rounded-sm transition-colors font-medium ${
                  page === i + 1
                    ...
                    : "bg-white/10 text-gray-300 border border-gray-700 hover:border-red-400 hover:text-red-400"
                }`}
              >
                {i + 1}
              </button>
