      ...
      <div className="min-h-screen text-gray-300 px-6 py-14 md:px-24 font-serif">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-center text-gray-400 mb-12 leading-relaxed">
            Welcome to <strong className="text-white">CEDRF Learning</strong>!
          ...
          <div className="space-y-8">
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                By accessing our platform, you confirm that you are at least 18
                years old or have legal parental or guardian consent. You agree
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                revision date. Continued use of our platform after changes means
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                login credentials. Any activity under your account will be
                deemed your responsibility. Notify us immediately of any
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                All website content, course materials, designs, logos, and
                trademarks are the intellectual property of{" "}
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                You agree not to misuse our services. Prohibited activities
                include hacking, posting offensive or misleading content,
                violating copyright, or engaging in behavior that disrupts
                learning or community standards.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                use our services, including data loss, service interruption, or
                unauthorized access.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                India. Any disputes shall be resolved under the exclusive
                jurisdiction of the courts in{" "}
                <strong className="text-white">Haldwani, India</strong>.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                collected and handled as per our{" "}
                <a
                  href="/privacy-policy"
                ...
                . We never sell or share your data without your consent.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                All paid courses and services are non-transferable. Refunds, if
                applicable, are governed by our Refund Policy. Please review
                eligibility terms carefully before making a payment.
              </p>
            </div>

            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              <h2 className="text-xl font-semibold text-white mb-3 font-serif">
                10. Course Access & Use
              </h2>
              <p className="text-gray-300 leading-relaxed">
                When you enroll in a course, you receive a limited,
                non-exclusive, non-transferable license to access content solely
                for personal and educational use. Sharing course content
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                Terms, abuse our services, or engage in harmful behavior. You
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                Our website may contain links to external sites. We do not
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                At <strong className="text-white">CEDRF Learning</strong>, we
                currently do not offer any physical products; therefore,
                shipping and delivery charges are not applicable. If physical
                items are introduced in the future (e.g., printed certificates
                or merchandise), the applicable shipping charges and delivery
                timelines will be clearly mentioned on the product or checkout
                page.
              </p>
              <p className="text-gray-300 leading-relaxed">
                As of now, all content and services are delivered digitally. You
                are responsible for ensuring your internet access and device
                compatibility to access course materials and services.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                For any questions regarding these Terms, feel free to reach out
                to us:
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <MdMarkEmailRead className="text-red-400 text-xl" />
                  <a
                ...
                <div className="flex items-center gap-3">
                  <IoPhonePortrait className="text-red-400 text-xl" />
                  <a
