    ...
    <div className="bg-black min-h-screen text-gray-300">
      <main className="max-w-4xl mx-auto font-serif px-6 py-12">
        ...
        <p className="mb-6 text-gray-300 leading-relaxed">
          ...
          like our <strong className="text-[#ff6d00]">DSA Pattern Course</strong>,
        ...
        <blockquote className="border-l-4 border-[#ff6d00] bg-gray-900 p-4 italic text-gray-400 mb-8 rounded-r">
          <p className="mb-2">
        ...
        <p className="mb-6 text-gray-300 leading-relaxed">
          ...
          course at just <strong className="text-[#ff6d00]">₹499</strong> so that
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 text-gray-300">
            <CgWebsite className="text-[#ff6d00]" size={20} />
            <span>Website:</span>
            <a
          ...
          <div className="flex items-center gap-3 text-gray-300">
            <MdMarkEmailRead className="text-[#ff6d00]" size={20} />
            <span>Email:</span>
            <a
