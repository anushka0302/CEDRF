        ...
        <div className="max-w-4xl mx-auto bg-gray-900 border border-gray-800 shadow-xl rounded-xl p-8 sm:p-12">
          ...
          <section className="mb-8">
            ...
            <p className="leading-relaxed text-gray-300">
              ...
              <strong className="text-[#ff6d00]">CEDRF Learning</strong> are for
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                <span className="text-[#ff6d00] mr-3 mt-1">•</span>
          ...
          <section className="mb-8">
            ...
            <p className="leading-relaxed text-gray-300">
              ...
              <a
                ...
                className="text-[#ff6d00] hover:text-[#ff6d00] underline transition-colors"
              >
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MdMarkEmailRead className="mt-1 text-[#ff6d00]" size={20} />
              ...
              <li className="flex items-start gap-3">
                <IoPhonePortrait className="mt-1 text-[#ff6d00]" size={20} />
                <div className="text-gray-300">
              ...
              <li className="flex items-start gap-3">
                <GoLaw className="mt-1 text-[#ff6d00]" size={20} />
                <div className="text-gray-300">
